        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Name = table.Column<string>(type: "varchar(255)", unicode: false, maxLength: 255, nullable: false),
                    CompaniesCutomerID = table.Column<int>(type: "int", nullable: false),
                    ImplementingCutomerID = table.Column<int>(type: "int", nullable: false),
                    DateStart = table.Column<DateTime>(type: "date", nullable: false),
                    DateEnd = table.Column<DateTime>(type: "date", nullable: true),
                    Priority = table.Column<int>(type: "int", nullable: false),
                    ProjectDirectorID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.CompaniesCutomerID,
                        principalTable: "Company",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_Project_Company1",
                        column: x => x.ImplementingCutomerID,
                        principalTable: "Company",
                        principalColumn: "ID");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_EmployeeToProject_Employee",
                        column: x => x.EmployeeID,
                        principalTable: "AspNetUsers",
                        principalColumn: "ID");
                    table.ForeignKey(
                        name: "FK_EmployeeToProject_Project",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Project_CompaniesCutomerID",
                table: "Project",
                column: "CompaniesCutomerID");

            migrationBuilder.CreateIndex(
                name: "IX_Project_ImplementingCutomerID",
                table: "Project",
                column: "ImplementingCutomerID");

            migrationBuilder.CreateIndex(
                name: "IX_Project_ProjectDirectorID",
                table: "Project",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Task_ImplementingCutomerID",
                table: "Task",
                column: "ImplementingCutomerID");
